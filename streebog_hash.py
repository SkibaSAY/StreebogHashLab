...
class Streebog:
    ...
    """
    nv = 512
    def __init__(self, n, h0) -> None:
        self.n = n
        self.h0 = h0

    def X_transform(self, k:List[bytes], a:List[bytes]) -> List[bytes]:
        """
        k XOR a
        """
        # return bytes(a ^ b for a, b in zip(k, a))
...
0x59, 0xA6, 0x74, 0xD2, 0xE6, 0xF4, 0xB4, 0xC0, 0xD1, 0x66, 0xAF, 0xC2, 0x39, 0x4B, 0x63, 0xB6
    ...
    def P_transform(self, a:List[bytes]) -> List[bytes]:
        """
...
0x07e095624504536c, 0x8d70c431ac02a736, 0xc83862965601dd1b, 0x641c314b2b8ee083
    ...
    def l_transform(self, a:List[bytes]) -> List[bytes]:
        """
        Представляет собой умножение 64-битного входного вектора на бинарную матрицу A размерами 64x64.
        """
        return [bytes(int.from_bytes(a)^int.from_bytes(self.A[i])) for i in range(0, 64)]
    ...
    def L_transform(self, a:List[bytes]) -> List[bytes]:
        ...
        result = []
        for i in range(0,8):
            result.append(self.l_transform(a[i*8:(i+1)*8]))
        return result


    def g(self, N:List[bytes], m:List[bytes], h:List[bytes]) -> List[bytes]:
        """
    ...
    def E(self, K:List[bytes], m:List[bytes]) -> List[bytes]:
        """
    ...
    def KeySchedule(self,K:List[bytes], i:int) -> List[bytes]:
        """
    ...
    def GetHash(self, M: List[bytes]) -> List[bytes]:
        """
